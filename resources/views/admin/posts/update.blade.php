        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">@lang('Update Post')</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="meta_title" class="form-control" value="{{ $post->meta_title }}" placeholder="Enter title">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control editor" name="description" placeholder="Enter description"> {!! $post->description !!} </textarea>
                                </div>
                            </div>
